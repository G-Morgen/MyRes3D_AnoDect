...
if __name__ == '__main__':
    ...
    train_normal_csv_path = os.path.join(csv_dir_path, 'normal.txt')
    train_anomaly_csv_path = os.path.join(csv_dir_path, 'anomaly.txt')
    val_csv_path = os.path.join(csv_dir_path, 'vallist01.txt')
    dst_json_path = os.path.join(csv_dir_path, 'dad.json')

    convert_ucf101_csv_to_activitynet_json(label_csv_path, train_normal_csv_path, train_anomaly_csv_path, val_csv_path, dst_json_path)
