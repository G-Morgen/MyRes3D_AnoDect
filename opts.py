...
def parse_opts():
    ...
    parser.add_argument('--view', default='front', type = str, help = "top view or front view data?")
    parser.add_argument('--image_type', default='D+IR', type = str, help = "depth, IR or D+IR")
    ...
    parser.add_argument('--lr_steps', default=[20, 40, 60, 130, 200, 250], type=float, nargs="+", metavar='LRSteps', help='epochs to decay learning rate by 10')
